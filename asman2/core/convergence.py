...
class ConvergenceEngine:
    ...
    async def _check_all_outputs_accessible(self, passenger: Passenger) -> bool:
        """检查所有产出物已生成"""
        required_outputs = ["merged_W2_SLICE", "merged_P3_SLICE", "merged_D3_SLICE"]
    ...
    def _generate_report(self, passenger: Passenger) -> Dict:
        ...
        return {
            ...
            "genre": passenger.ticket.config.genre,
...
import time  # for convergence.py
