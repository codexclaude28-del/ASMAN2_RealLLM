...
from .hermes_config import HermesProfile
...
class HermesWorker:
    ...
    def __init__(self, station_id: str, llm_client: LLMClient = None):
        ...
        self.profile = get_profile(station_id) or HermesProfile(name=station_id, system_prompt="")
    ...
    def _build_prompt(self, input_data: Dict) -> str:
        ...
        genre = params.get("genre", "") if isinstance(params, dict) else ""
        style = params.get("style", "") if isinstance(params, dict) else ""
